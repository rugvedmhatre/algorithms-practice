...
However, while decoding the message, you realize that there are
many different ways you can decode the message because some 
...
Output: 3
Explanation:
"226" could be decoded as "BZ" (2 26), "VF" (22 6), or 
"BBF" (2 2 6).
...
("6" is different from "06"). In this case, the string is not a
